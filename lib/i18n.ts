...
const dict = {
  en: {
    ...
    title: "Title", past: "Past", noWeeks: "No weeks uploaded yet.", uploadedOn: "read on",
    uploadBoth: "Upload weekly plan + timetable", uploadShort: "Upload", planDoc: "Weekly plan", ttDoc: "Timetable", ttOptional: "Only if it changed", chooseFile: "Choose file",
  ...
  ar: {
    ...
    title: "العنوان", past: "سابق", noWeeks: "لم تُرفع أي أسابيع بعد.", uploadedOn: "قُرئ في",
    uploadBoth: "رفع الخطة الأسبوعية + الجدول", uploadShort: "رفع", planDoc: "الخطة الأسبوعية", ttDoc: "الجدول", ttOptional: "فقط إذا تغيّر", chooseFile: "اختيار ملف",
