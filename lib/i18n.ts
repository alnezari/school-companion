...
const dict = {
  en: {
    ...
    fixedSection: "Fixed time", basketSection: "Basket", clashesWith: "Clashes with", outsideWindow: "Outside his day window", needsMove: "Clashes, remove it", gone: "To do",
  ...
  ar: {
    ...
    fixedSection: "وقت ثابت", basketSection: "السلة", clashesWith: "يتعارض مع", outsideWindow: "خارج نافذة يومه", needsMove: "يتعارض، أزله", gone: "لم يُنجز بعد",
