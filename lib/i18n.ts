...
const dict = {
  en: {
    ...
    fetchWeek: "Fetch week", readAgain: "Read this week again from the school folder", readAgainConfirm: "Read this week again? Its lessons will be replaced; the stars stay.", readingAgain: "Reading again…", waitingDocs: "Waiting for the school documents", pulledOn: "Pulled from the school folder", uploadedByHand: "Uploaded by hand", notInFolder: "is not in the school folder yet", allFetched: "Every week is in", week1Start: "First week started on", uploadByHand: "Upload by hand", fetched: "fetched", waiting: "waiting", lastChecked: "Last checked", nothingNew: "nothing new", weekReady: "is ready", fetchedAuto: "fetched from the school folder", checking: "Looking in the school folder…", noFolders: "Add the school folder links in Settings first.", schoolClass: "Class", planFolder: "Weekly plan folder link", ttFolder: "Timetable folder link", notifWeekReady: "📚 A new week was fetched", open: "Open", alsoThisWeek: "Also this week", uploadTimedOut: "It took too long and stopped. Try again.",
