...
const dict = {
  en: {
    ...
    finished: "Finished", tapBookToo: "or tap a book", zipping: "Zipping up…", packShort: "Pack your bag 🎒", readyShort: "Ready for tomorrow ✨",
  ...
  ar: {
    ...
    finished: "المنتهي", tapBookToo: "أو اضغط على كتاب", zipping: "نغلق الحقيبة…", packShort: "جهّز حقيبتك 🎒", readyShort: "جاهز للغد ✨",
