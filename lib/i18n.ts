...
const dict = {
  en: {
    ...
    parentTitle: "Week", today: "Today", classesShort: "classes", hwShort: "homework", upload: "Upload weekly plan", original: "Open original document", noWeek: "No plan uploaded for this week.",
    ...
    needsParent: "Needs you at home", weekOf: "Week", logout: "Sign out", settings: "Settings", changePin: "Parent PIN", save: "Save", saved: "Saved",
    ...
    timetable: "Timetable", validFrom: "Valid from", weeks: "Weeks", currentWeek: "Current week", oldWeek: "You are looking at a past week", backToCurrent: "Back to this week", futureWeek: "This is a coming week",
    ...
    fixTimetable: "Fix the timetable by hand", alsoThisWeek: "Also this week", uploadTimedOut: "It took too long and stopped. Try again.",
    ...
    finished: "Finished", finishedHow: "I finished! How did it feel?", packAll: "All into the bag", tapToClose: "Tap the book to close it", tapBookToo: "or tap a book", zipping: "Zipping up…", packShort: "Pack your bag 🎒", readyShort: "Ready for tomorrow ✨", bagPackedTitle: "Your bag is packed!", bagPackedSub: "You are ready for tomorrow",
  ...
  ar: {
    ...
    parentTitle: "الأسبوع", today: "اليوم", classesShort: "حصص", hwShort: "واجب", upload: "رفع الخطة الأسبوعية", original: "فتح المستند الأصلي", noWeek: "لم تُرفع خطة لهذا الأسبوع.",
    ...
    needsParent: "يحتاج متابعتكم في البيت", weekOf: "أسبوع", logout: "تسجيل الخروج", settings: "الإعدادات", changePin: "رمز الوالدين", save: "حفظ", saved: "تم الحفظ",
    ...
    timetable: "الجدول", validFrom: "ساري من", weeks: "الأسابيع", currentWeek: "الأسبوع الحالي", oldWeek: "أنت تشاهد أسبوعًا سابقًا", backToCurrent: "العودة إلى هذا الأسبوع", futureWeek: "هذا أسبوع قادم",
    ...
    fixTimetable: "تصحيح الجدول يدويًا", alsoThisWeek: "أيضًا هذا الأسبوع", uploadTimedOut: "استغرق وقتًا طويلًا وتوقف. حاول مرة أخرى.",
    ...
    finished: "المنتهي", finishedHow: "أنهيت! كيف كان؟", packAll: "الكل في الحقيبة", tapToClose: "اضغط على الكتاب لإغلاقه", tapBookToo: "أو اضغط على كتاب", zipping: "نغلق الحقيبة…", packShort: "جهّز حقيبتك 🎒", readyShort: "جاهز للغد ✨", bagPackedTitle: "حقيبتك جاهزة!", bagPackedSub: "أنت جاهز للغد",
